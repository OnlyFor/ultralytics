...
<p align="center">
    <img width="640" src="https://github.com/ultralytics/docs/releases/download/0/lvis-dataset-example-images.jpg" alt="LVIS Dataset example images">
</p>
...
![LVIS Dataset sample image](https://github.com/ultralytics/docs/releases/download/0/lvis-mosaiced-training-batch.jpg)
